...
public class SwaggerConstants {
    ...
    public static final String  CONTACT_EMAIL="shohdiyortoshtemirov@gamil.com";
    public static final String  CONTACT_NAME="support force";
    ...
    public static final String  API_TAG = "Transaction  ";
